...
namespace ASP.NET_Web.Services
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<OrderCreatedViewModel> CreateOrder(CheckoutInfoInput checkoutInfoInput)
        {
            ...
            var orderCreatedViewModel = await response.Content.ReadFromJsonAsync<Responce<OrderCreatedViewModel>>();
        ...
        {
            var response = await _httpClient.GetFromJsonAsync<Responce<List<OrderViewModel>>>("orders");
