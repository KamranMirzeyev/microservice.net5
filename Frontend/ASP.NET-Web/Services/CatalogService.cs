...
namespace ASP.NET_Web.Services
{
    public class CatalogService : ICatalogService
    {
        ...
        public async Task<List<CategoryViewModel>> GetAllCategoryAsync()
        {
            ...
            var responseSuccess = await response.Content.ReadFromJsonAsync<Responce<List<CategoryViewModel>>>();
        ...
        public async Task<List<CourseViewModel>> GetAllCourseAsync()
        {
            ...
            var responseSuccess = await response.Content.ReadFromJsonAsync<Responce<List<CourseViewModel>>>();
        ...
        public async Task<CourseViewModel> GetByCourseId(string courseId)
        {
            ...
            var responseSuccess = await response.Content.ReadFromJsonAsync<Responce<CourseViewModel>>();
